...
export type DashboardPageModel = Pick<
  DashboardController,
  | 'activeRoom'
  | 'activeSection'
  | 'connecting'
...
export type DashboardOverlayModel = Pick<
  DashboardController,
  | 'activeRoom'
  | 'activeSection'
  | 'addableEntityIds'
...
export type DashboardSectionModel = Pick<
  DashboardController,
  | 'activeRoom'
...
export interface DashboardComposition {
  ...
  overlays: DashboardOverlayModel;
