...
export function FogOverlaySvg({
  ...
  const motionClassName =
    effectsQuality === 'high'
      ? 'motion-safe:animate-[navet-weather-fog-drift_30s_ease-in-out_infinite_alternate] motion-safe:will-change-transform [transform-box:view-box]'
      : effectsQuality === 'medium'
        ? 'motion-safe:animate-[navet-weather-fog-drift_42s_ease-in-out_infinite_alternate] motion-safe:will-change-transform [transform-box:view-box]'
        : undefined;
