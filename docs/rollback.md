...
If a Cloudflare Pages deployment must be reverted, redeploy the earlier known-good commit rather
than treating the website bundle as the user rollback channel for runtime installs.
