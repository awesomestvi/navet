...
Select a built-in accent or define a custom accent. The accent emphasizes state and controls; it
does not replace semantic colors for warnings, security, or device state.
