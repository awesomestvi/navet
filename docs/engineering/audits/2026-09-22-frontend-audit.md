...
| --- | --- | --- |
| `BUNDLE-DEMO-INITIAL` | After section and sample data splitting, the demo still emits a 1,087 KiB entry script and a 569 KiB stylesheet. The home view imports many card families and fixtures. | Profile the initial home graph and split only components whose loading state can preserve the current card layout and interactions. |
