...
services. Homey also supplies climate, speaker, security, scene, presence, notification, Insights,
favorite, and hub-resource capabilities. openHAB also supplies fans, climate setpoints, speaker
controls, locks, covers, security sensors, batteries, and utility measurements.
