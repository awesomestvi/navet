...
- addable widgets for info summaries, RSS, photos, notes, battery and UPS status, live energy,
  action buttons, Home Assistant Assist, Home insights, maps, and generic provider entities
...
- installation-local Home insights in Docker and the Home Assistant add-on; these are
